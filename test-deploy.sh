...
echo "  - Nando Dev (nandinhos@gmail.com) / REDACTED (definida via env ADMIN_NANDO_PASSWORD)"
echo "  - Angelica Domingos (angelica.domingos@hotmail.com) / REDACTED (definida via env ADMIN_ANGELICA_PASSWORD)"
echo ""
